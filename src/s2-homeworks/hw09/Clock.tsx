...
function Clock() {
    ...
    const stringDay = date.toLocaleDateString('en-US', dayOptions) || <br/> // пишут студенты
    const stringMonth = date.toLocaleDateString('en-US', monthOptions) || <br/> // пишут студенты
